 ...
 */
export declare function renderTimelineToString(items: TimelineItem[], groups: TimelineGroup[], options?: TimelineOptions): string;
/**
 * Render timeline to DOM element (browser only)
 */
export declare function renderTimeline(items: TimelineItem[], groups: TimelineGroup[], options?: TimelineOptions): HTMLTableElement;
/**
 ...
 */
export declare function createResizeHandler(callback: () => void, delay?: number): {
    attach: () => void;
    detach: () => void;
};
/**
