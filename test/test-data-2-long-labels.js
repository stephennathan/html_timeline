...
export const items = [
  ...
  { id: 17, content: "Technical Documentation Update for New API Endpoints and Integration Guidelines", group: 5, start: "2024-04-29", end: "2024-05-03", type: "box", className: "info" },
  { id: 18, content: "End User Training Material Development and Learning Management System Upload", group: 5, start: "2024-04-29", end: "2024-05-06", type: "box", className: "purple" },
  { id: 19, content: "Administrator Guide Creation with Troubleshooting Procedures and Escalation Paths", group: 5, start: "2024-05-01", end: "2024-05-08", type: "box" },
  { id: 20, content: "Training Session Delivery: Wave 1 Regional Teams and Support Staff Certification", group: 5, start: "2024-05-06", end: "2024-05-10", type: "box", className: "success" },
  { id: 21, content: "Documentation Review Complete", group: 5, start: "2024-05-10", type: "point", className: "success" },

  // Release and communication items
  { id: 22, content: "Executive Stakeholder Communication and Change Management Notification Distribution", group: 6, start: "2024-05-13", end: "2024-05-14", type: "box", className: "warning" },
  { id: 23, content: "Customer Communication Campaign Launch with Feature Announcement and Migration Timeline", group: 6, start: "2024-05-15", end: "2024-05-17", type: "box", className: "info" },
  { id: 24, content: "Partner Integration Support Window and Technical Assistance Hotline Activation", group: 6, start: "2024-05-15", end: "2024-05-22", type: "box", className: "purple" },
  { id: 25, content: "Feedback Collection and Customer Satisfaction Survey Distribution Phase One", group: 6, start: "2024-05-20", end: "2024-05-24", type: "box", className: "pink" },
  { id: 26, content: "Release Retrospective Meeting with Cross-Functional Teams and Lessons Learned Workshop", group: 6, start: "2024-05-27", end: "2024-05-28", type: "box" },

  // Post-launch monitoring
  { id: 27, content: "30-Day Post-Launch Performance Review and Key Metrics Analysis Presentation", group: 6, start: "2024-05-28", type: "point", className: "success" },
  { id: 28, content: "Bug Triage and Priority Assessment for Version 1.1 Patch Release Planning", group: 4, start: "2024-05-01", end: "2024-05-08", type: "box", className: "danger" },
  { id: 29, content: "Database Optimization and Index Tuning Based on Production Query Analysis", group: 4, start: "2024-05-06", end: "2024-05-13", type: "box", className: "warning" },
  { id: 30, content: "Capacity Planning Review for Q3 Traffic Projections and Infrastructure Budgeting", group: 4, start: "2024-05-13", end: "2024-05-17", type: "box", className: "info" },
];
